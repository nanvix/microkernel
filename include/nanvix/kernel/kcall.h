...
#define NR_mailbox_assign 28 /** kernel_mailbox_assign()   */
#define NR_mailbox_link 29   /** kernel_mailbox_link()     */
#define NR_mailbox_unlink 30 /** kernel_mailbox_unlink()   */
#define NR_mailbox_push 31   /** kernel_mailbox_push()     */
#define NR_mailbox_pop 32    /** kernel_mailbox_pop()      */
#define NR_last_kcall 33     /** NR_SYSCALLS definer       */
